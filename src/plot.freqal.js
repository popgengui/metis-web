...
const plot_spec = conf => {
	...
	},
	{
		...
		"encoding":{
			...
			"y":{ "field":"hemean", "type":"quantitative" },
			"text":{ "field": "meantext", "type":"nominal"}
		}
	},
	{
		"mark":{ 
		...
		"encoding":{
			"x":{ "field":"xplus", "type":"quantitative" },
			"y":{ "field":"yvalfixed", "type":"quantitative" },
			"text":{ "field": "totfixed", "type":"nominal"}
		}
	},
	{
		"mark":{ 
		...
		"encoding":{
			"x":{ "field":"xplus", "type":"quantitative" },
			"y":{ "field":"yvallost", "type":"quantitative" },
			"text":{ "field": "totlost", "type":"nominal"}
		}
	}
    ]
    }`}
...
export const PlotFreqal = (conf, sources) => {
    const where = conf.id
